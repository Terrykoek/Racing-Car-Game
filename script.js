$(function () {
    ...
    //listening on 'document for a clik on keyboard down, a function with event will occur
    $(document).on('keydown', function (e) {    //keycode for keydown=40
        ...
        if (endGame === false) {
            ...
            if (key === 37) { //keycode for left key is 37
                //requestAnimaitonFrame tells browser i wish to perform an animation and request that browser calls specific function to update an animation before next repaint.
                //need to call request animationframe again as its a 1shot
    ...
    function repeat() {
        ...
        if (scoreCount % 100 == 0) { //increase speed of opposite car
            carSpeed++;
            lineSpeed++;
        }
